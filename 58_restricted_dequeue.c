...
This C program implements input and output restricted dequeues. In an 
input restricted dequeue, insertions can be done only at one of the ends.
In an output restricted dequeue, deletions can be done at only one of the
ends while insertions can be done from both ends.
